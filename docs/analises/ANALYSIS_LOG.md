...
**Método:** Ver `docs/analises/DATA_QUALITY.md` (checks completos).
...
**Evidência:** `docs/analises/DATA_QUALITY.md`; `reports/eda/eda_results.json → consistency_pessoas_vs_vitimas, km_zero_or_negative`.
...
**Evidência:** `reports/eda/eda_results.json → severity_rate_by_column['tipo_pista']`; `docs/analises/DATA_QUALITY.md §4`.
