...
Todo número desta página é recomputado do banco a cada carregamento — se os dados mudarem,
o texto acompanha.
"""
import numpy as np
import pandas as pd
...
card(
    ...
    "🗺️ Geografia e docs/analises/EDA.md §9 (limitações).",
)
...
st.divider()
st.header("4. Checklist da disciplina")

with st.expander("✅ Ver Checklist da Disciplina — onde cada item foi atendido", expanded=False):
    checklist = pd.DataFrame([
        ...
        ("Abordagens justificadas", "todas + docs/decisoes/DECISIONS.md", "cada escolha metodológica tem uma decisão registrada (D-01…D-13)"),
        ("Insights documentados", "💡 esta página · docs/analises/ANALYSIS_LOG.md", "achados com evidência recalculada e grau de confiança"),
