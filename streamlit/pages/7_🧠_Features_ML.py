...
st.set_page_config(page_title="Features para ML", page_icon="🧠", layout="wide")
...
st.caption(
    ...
    "(skill `eda`/`feature-engineering`; ver docs/ANALYSIS_LOG.md A-18 e docs/DECISIONS.md D-07)."
)
...
st.subheader("Mapa de leakage (conceitual, não estatístico)")
...
st.caption(
    "Relação com o target mostrada apenas para caracterização exploratória — nunca use associação alta "
