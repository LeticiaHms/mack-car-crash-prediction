"""
Pré-processamento dos dados de acidentes da PRF (2022-2026).

Lê os CSVs brutos (`dados/datatran*.csv`), padroniza tipos e formatos,
trata valores ausentes de forma documentada, remove duplicidades e
...
def clean_dataframe(df):
    ...
    # encontrada em 1 registro de dados/datatran2024.csv), convertendo
...
def main():
    ...
    stats['arquivos_processados'] = sorted(raw_files)
