...
with st.expander("ℹ️ Como `gravidade_4` é definida (regra de negócio)"):
    st.markdown(
        ...
        "(ver docs/decisoes/DECISIONS.md D-01)."
    )
...
st.info(
    "ℹ️ Contagem absoluta reflete exposição (quanto se trafega ali), não apenas risco — "
...
tab_abs, tab_pct = st.tabs(["Valores Absolutos", "Percentuais Condicionais"])
with tab_abs:
