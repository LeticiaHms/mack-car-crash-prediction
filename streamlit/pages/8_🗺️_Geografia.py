...
with tab_uf:
    ...
    if rate.empty:
        ...
        if dim == "br":
            st.caption("`br = 0` foi excluído: é um placeholder de rodovia não identificada ([D-05](../docs/DECISIONS.md)).")
...
with tab_trechos:
    ...
    if trechos.empty:
        ...
        st.warning(
            ...
            "que seria a métrica ideal (limitação registrada em docs/specs/eda/EDA.md §9)."
        )
