...
import eda_utils as eu  # noqa: E402  (o sys.path é ajustado em common.py)
...
with tab_falta:
    ...
    st.warning(
        ...
        "[D-04](../docs/DECISIONS.md) (manter `km≤0`, sinalizado) e "
        "[D-05](../docs/DECISIONS.md) (excluir `br=0` de rankings por rodovia)."
    )
...
with tab_coerencia:
    ...
    st.markdown(
        ...
        **Leitura crítica.** A única divergência relevante é a primeira: {n_mismatch:,} registros
        ...
        ([D-03](../docs/DECISIONS.md)). A consequência prática é direta: **use as colunas de vítimas
