    ...
    if method.startswith("IQR"):
        ...
        if lo == hi:
            st.warning(
                ...
                "como outlier. Prefira Z-score para colunas de contagem rara (ver docs/DECISIONS.md D-06)."
            )
    else:
    ...
    if len(rate) < 2:
        ...
        if dim == "br":
            st.caption(
                ...
                "(docs/DECISIONS.md D-05). Rodovias com n pequeno merecem cautela (intervalo de confiança largo)."
            )
